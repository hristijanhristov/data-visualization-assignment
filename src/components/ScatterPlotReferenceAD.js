...
function ScatterPlotReferenceAD({ data }) {
    const ref = useRef();
    ...
    useEffect(() => {
        ...
        svg.selectAll('circle')
            ...
            .on("mouseover", function(event, d) {
                div.transition()
                    .duration(200)
                    .style("opacity", .9);
                div.html(`Chromosome: ${d.chrom}<br/>Reference Allele Depth: ${d.info[5].AD.split(',')[0]}`)
        ...
        svg.append("text")
            ...
            .text("Chromosomes vs Reference Allele Depth");
    }, [data]);
...
export default ScatterPlotReferenceAD;
